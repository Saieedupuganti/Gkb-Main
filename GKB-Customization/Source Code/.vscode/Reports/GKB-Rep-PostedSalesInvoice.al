...
report 60110 "Sales - Invoice"
{
    ...
    DefaultRenderingLayout = "SalesInvoice.docx";
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(WorkDescriptionLineInvoice; WorkDescriptionLine)
            {
            }
