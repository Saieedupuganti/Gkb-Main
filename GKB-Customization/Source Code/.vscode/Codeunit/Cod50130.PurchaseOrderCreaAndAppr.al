...
//         Message('Purchase Order Created with %1', PurchaseHDR."No.");
...
codeunit 50130 "Create Order helper"
{
    ...
    begin
        ...
        if RequisitionLine.FindSet() then begin
            ...
            // Show a single message with all PO numbers at the end
            ...
            //         end;
            //         MessageText += Part;
            //         if PurhaseHeaderNoList.IndexOf(Part) < PurhaseHeaderNoList.Count - 1 then
            //             MessageText += ', ';
            //     end;
            //     Message(MessageText);
            // end;
