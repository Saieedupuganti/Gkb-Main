codeunit 50501 "Work Order Mgmt"
{
    ...
    begin
        if BCTableNo = DATABASE::"Work Order" then begin
    ...
    begin
        InsertIntegrationProjectMapping(IntegrationTableMapping, 'Work Order', DATABASE::"Work Order", DATABASE::"CDS msdyn_workorder", CDSworkorder.FieldNo(msdyn_workorderId), CDSworkorder.FieldNo(msdyn_workorderId), '', '', true);
        InsertIntegrationProjectMapping('Project', WorkOrder.FieldNo("Work Order Number"), CDSworkorder.FieldNo(msdyn_workorderId), IntegrationFieldMapping.Direction::FromIntegrationTable, '', true, false);
